    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button = "login")
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(result.Succeeded)
                {
                    ...
                    await _events.RaiseAsync(new UserLoginSuccessEvent(user.UserName, user.Id, $"{user.FirstName} {user.LastName}", clientId: context?.ClientId));
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    return Redirect($"login?returnUrl={System.Web.HttpUtility.UrlEncode(returnUrl)}");
                }
                else
                {
